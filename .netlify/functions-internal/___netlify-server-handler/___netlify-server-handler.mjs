...
import { getTracer, withActiveSpan } from '/var/task/apps/web/.netlify/dist/run/handlers/tracer.cjs'
...
export default async function (req, context) {
  ...
  const handlerResponse = await runWithRequestContext(requestContext, () => {
    return withActiveSpan(tracer, 'Next.js Server Handler', async (span) => {
      ...
      if (!cachedHandler) {
        const { default: handler } = await import('/var/task/apps/web/.netlify/dist/run/handlers/server.js')
